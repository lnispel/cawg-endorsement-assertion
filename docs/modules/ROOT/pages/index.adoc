...
*Version 2.0 Draft 15 July 2024* · xref:_version_history[]
...
_<<_forward_permissions_credential,Forward Permissions Credentials>>_ follow the W3C Verifiable Credentials Data Model and include the following key components:

* **Licensee identification** - DID and credential hash of the party receiving permissions
* **Asset reference** - C2PA manifest hash and relationship to the original asset
* **Permitted actions** - List of allowed C2PA actions
* **ODRL policy** - Machine-readable terms, constraints, and obligations
* **Issuer identity** - Reference to the licensor's ICAC for identity assurance
* **Metadata** - Signature algorithm, timestamps, and revocation information
